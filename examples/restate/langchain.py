# Agent using Outbox Restate destination + LangChain
...
# Run with: hypercorn langchain:app --bind 0.0.0.0:9080

if __name__ == "__main__":
    asyncio.run(
        outbox.destinations.create(
            destination_id="restate-langchain",
            display_name="Restate LangChain agent",
            target_type="restate",
            target_config={
