...
@pytest.mark.asyncio
async def test_typing_indicator_sends_false_on_exception(ns: MessagesNamespace, mock_msg_client: AsyncMock) -> None:
    resp = message_pb2.SendTypingIndicatorResponse()
    mock_msg_client.send_typing_indicator = AsyncMock(return_value=resp)
...
@pytest.mark.asyncio
async def test_send_with_reply_to_none_omits_field(ns: MessagesNamespace, mock_msg_client: AsyncMock) -> None:
    resp = message_pb2.CreateMessageResponse()
    resp.message.CopyFrom(_make_message())
    resp.delivery.message = "messages/msg-1"
    mock_msg_client.create_message = AsyncMock(return_value=resp)
...
@pytest.mark.asyncio
async def test_send_minimal_params_sets_no_optional_fields(ns: MessagesNamespace, mock_msg_client: AsyncMock) -> None:
    resp = message_pb2.CreateMessageResponse()
    resp.message.CopyFrom(_make_message())
    mock_msg_client.create_message = AsyncMock(return_value=resp)
