...
def test_map_delivery_event_message() -> None:
    ...
    assert result.message.id == "msg-1"  # type: ignore[union-attr]
...
def test_map_delivery_event_delivery_update() -> None:
    ...
    assert result.connector_id == "conn-1"
    assert result.delivery_update.message_id == "msg-2"  # type: ignore[union-attr]
    assert result.delivery_update.status == MessageDeliveryStatus.DELIVERED  # type: ignore[union-attr]
...
def test_map_delivery_event_read_receipt() -> None:
    ...
    assert result.read_receipt.message_ids == ["msg-1"]  # type: ignore[union-attr]
...
def test_map_delivery_event_typing_indicator() -> None:
    ...
    assert result.typing_indicator.typing is True  # type: ignore[union-attr]
