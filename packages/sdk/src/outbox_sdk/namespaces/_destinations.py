...
_VALID_TARGET_TYPES: frozenset[str] = frozenset(DestinationTargetType.__args__)


def _apply_target_config(target_msg: object, target_config: dict[str, object]) -> None:
        ...
        *,
        ...
        if target_config:
            ...
            if target_msg is not None:
                _apply_target_config(target_msg, target_config)
