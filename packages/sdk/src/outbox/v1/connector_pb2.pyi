...
class DnsRecord(_message.Message):
    __slots__ = ("type", "name", "value", "priority", "note", "verified")
    ...
    note: str
    verified: bool
    def __init__(self, type: _Optional[str] = ..., name: _Optional[str] = ..., value: _Optional[str] = ..., priority: _Optional[int] = ..., note: _Optional[str] = ..., verified: _Optional[bool] = ...) -> None: ...
